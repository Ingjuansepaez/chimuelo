...
def generate_launch_description():
    ...
    model_arg = DeclareLaunchArgument(name='chimuelo', description='Absolute path to robot urdf file')
    ...
    urdf_file_name = 'chimuelo_d.urdf'
    urdf = os.path.join(
        get_package_share_directory('chimuelo'),
        'urdf',
        urdf_file_name
        )
